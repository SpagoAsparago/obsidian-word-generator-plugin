...
### Automated saving
Patterns and main patterns are automatically saved to Obsidian settings when closing the word generator page or clicking the 'Generate' button, as well as importing from a configuration file.
